...
if __name__ == "__main__":
    ...
    model_save_path = PROJ_PATH + 'data/model/A.1/epoch=29-train_cross_entropy_loss=1.28-train_map5=0.82-val_map5=0.06.ckpt'
    ...
    submit_save_path = PROJ_PATH + 'data/process/exp/A.1/submit.csv'
    ...
    #     preds = inf_model.predict(val_embeds, thr=thr, mode='min')
    #
    #     map5 = []
    ...
    # for thr in thrs:
    #     #preds = inf_model.predict(val_embeds, print_quantile=True, thr=thr)
    #     preds = inf_model.predict(val_embeds, thr=thr, mode='mean')
    #
    #     map5 = []
    #     for val_target, pred in zip(val_targets_filtered, preds):
    #         map5.append(map_per_image(val_target, pred))
