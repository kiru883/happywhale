...
if __name__ == "__main__":
    ...
    model_save_path = PROJ_PATH + 'data/model/B.2/epoch=27-train_cross_entropy_loss=1.49-val_map5=val_map5=0.18-val_map5=val_map5=0.18.ckpt'
    ...
    submit_save_path = PROJ_PATH + 'data/process/exp/B.2/submit.csv'
