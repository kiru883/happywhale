...
if __name__ == "__main__":
    ...
    model_save_path = PROJ_PATH + 'data/model/B.2_384/epoch=29-train_cross_entropy_loss=0.13-val_map5=val_map5=0.23-val_map5=val_map5=0.23.ckpt'
    ...
    submit_save_path = PROJ_PATH + 'data/process/exp/B.2/submit_384.csv'
    ...
    imgs = [i.replace('.png', '.jpg') for i in imgs]
    ...
    #thrs = [0.31, 0.4, 0.48, 0.54, 0.57, 0.60, 0.637, 0.67]
